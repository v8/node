...
$(obj).target/test_function.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_function.node: LIBS := $(LIBS)
$(obj).target/test_function.node: TOOLSET := $(TOOLSET)
$(obj).target/test_function.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_function.node
# Add target alias
.PHONY: test_function
...
$(builddir)/test_function.node: $(obj).target/test_function.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_function.node
# Short alias for building this executable.
.PHONY: test_function.node
test_function.node: $(obj).target/test_function.node $(builddir)/test_function.node
