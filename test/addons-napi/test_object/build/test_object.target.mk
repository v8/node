...
$(obj).target/test_object.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_object.node: LIBS := $(LIBS)
$(obj).target/test_object.node: TOOLSET := $(TOOLSET)
$(obj).target/test_object.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_object.node
# Add target alias
.PHONY: test_object
...
$(builddir)/test_object.node: $(obj).target/test_object.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_object.node
# Short alias for building this executable.
.PHONY: test_object.node
test_object.node: $(obj).target/test_object.node $(builddir)/test_object.node
