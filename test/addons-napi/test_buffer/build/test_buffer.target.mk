...
$(obj).target/test_buffer.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_buffer.node: LIBS := $(LIBS)
$(obj).target/test_buffer.node: TOOLSET := $(TOOLSET)
$(obj).target/test_buffer.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_buffer.node
# Add target alias
.PHONY: test_buffer
...
$(builddir)/test_buffer.node: $(obj).target/test_buffer.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_buffer.node
# Short alias for building this executable.
.PHONY: test_buffer.node
test_buffer.node: $(obj).target/test_buffer.node $(builddir)/test_buffer.node
