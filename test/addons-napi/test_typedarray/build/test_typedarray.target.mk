...
$(obj).target/test_typedarray.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_typedarray.node: LIBS := $(LIBS)
$(obj).target/test_typedarray.node: TOOLSET := $(TOOLSET)
$(obj).target/test_typedarray.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_typedarray.node
# Add target alias
...
$(builddir)/test_typedarray.node: $(obj).target/test_typedarray.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_typedarray.node
# Short alias for building this executable.
.PHONY: test_typedarray.node
test_typedarray.node: $(obj).target/test_typedarray.node $(builddir)/test_typedarray.node
