...
$(obj).target/test_constructor.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_constructor.node: LIBS := $(LIBS)
$(obj).target/test_constructor.node: TOOLSET := $(TOOLSET)
$(obj).target/test_constructor.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_constructor.node
# Add target alias
...
$(builddir)/test_constructor.node: $(obj).target/test_constructor.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_constructor.node
# Short alias for building this executable.
.PHONY: test_constructor.node
test_constructor.node: $(obj).target/test_constructor.node $(builddir)/test_constructor.node
