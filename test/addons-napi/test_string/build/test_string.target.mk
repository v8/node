...
$(obj).target/test_string.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_string.node: LIBS := $(LIBS)
$(obj).target/test_string.node: TOOLSET := $(TOOLSET)
$(obj).target/test_string.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_string.node
# Add target alias
.PHONY: test_string
...
$(builddir)/test_string.node: $(obj).target/test_string.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_string.node
# Short alias for building this executable.
.PHONY: test_string.node
test_string.node: $(obj).target/test_string.node $(builddir)/test_string.node
